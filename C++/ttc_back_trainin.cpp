...
class TicTacToe
{
    ...
    void mediummove()   //For Computer move Medium mode
    {
...
void mainmenu()     //For mainmenu
{
    int choice1, difficulty, choice2;
    char x, y;

    do      //loop for menu for tic tac toe
    {
        ...
        switch(choice1)
        {
            case 1:     //Menu to select PVP or CVP mode
            {
            ...
            default:    //If choice is not between 1 - 3
